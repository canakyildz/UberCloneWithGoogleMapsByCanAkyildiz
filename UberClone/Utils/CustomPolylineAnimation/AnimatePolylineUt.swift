...
open class AnimatePolyline {
    ...
    lazy var startMarker = GMSMarker()
    lazy var endMarker = GMSMarker()
    ...
    func disregardEvents() {
        currentSegment.path = nil
        backgroundSegment.path = nil
        currentSegment.map = nil
        backgroundSegment.map = nil
        startMarker.map = nil
        endMarker.map = nil
        route = []
        totalSteps = 0
